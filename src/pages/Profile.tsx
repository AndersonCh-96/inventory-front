...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center  overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
