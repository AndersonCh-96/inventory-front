...
const SignIn: React.FC = (props: any) => {
  ...
  const validation: any = useFormik({
    ...
    onSubmit: (values: any) => {
      if (values) {
        setLoading(true);
        dispatch(loginUser({ user: validation.values, navigate }));
      }
      setLoading(false);
    },
  });
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
                >
